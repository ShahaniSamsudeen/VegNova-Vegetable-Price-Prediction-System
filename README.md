...
The platform integrates machine learning, data analytics, computer vision, and interactive web technologies to assist farmers with crop planning, market understanding, and agricultural decision-making. A Linear Regression model enhanced with lag-based and cost-related features is used for 30-day vegetable price forecasting, while a YOLOv8 deep learning model is used for tomato detection and classification.
