...
DATASET_PATH = os.path.join(
    BASE_DIR,
    "datasets",
    "carrot_complete_growth_dataset.xlsx"
)

OUTPUT_CSV = os.path.join(BASE_DIR, "carrot_price_forecast.csv")
OUTPUT_XLSX = os.path.join(BASE_DIR, "carrot_price_forecast.xlsx")
...
data = df[feature_cols + ["Carrot_Min_Price", "Carrot_Max_Price"]]
